...
### Примечания
После запуска server.bat автоматически откроется страница в браузере с данным приложением. Перывый запуск дольше последующих, поэтому может потребоваться перезагрузка страницы (клавиша f5).
